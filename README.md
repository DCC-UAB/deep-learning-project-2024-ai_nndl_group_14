...
The model used on this is the same as in the notebook [Project_NN_v6_WORKSWELL.ipynb](https://github.com/DCC-UAB/deep-learning-project-2024-ai_nndl_group_14/blob/main/notebooks/Project_NN_v6_WORKSWELL.ipynb).
